...
// This file copy from devtools because extension is tiptap pro version
...
function ae(a: any) {
  var o;
  const { char: e, allowSpaces: s, allowedPrefixes: n, startOfLine: r, $position: g } = a,
    i = N(e),
    D = new RegExp(`\\s${i}$`),
    u = r ? '^' : '',
    j = s
      ? new RegExp(`${u}${i}.*?(?=\\s${i}|$)`, 'gm')
      : new RegExp(`${u}(?:^)?${i}[^\\s${i}]*`, 'gm'),
    v = ((o = g.nodeBefore) === null || o === void 0 ? void 0 : o.isText) && g.nodeBefore.text;
  if (!v) return null;
  const _ = g.pos - v.length,
    p = Array.from(v.matchAll(j)).pop() as any;
  if (!p || p.input === void 0 || p.index === void 0) return null;
  const t = p.input.slice(Math.max(0, p.index - 1), p.index),
    h = new RegExp(`^[${n == null ? void 0 : n.join('')}\0]?$`).test(t);
  if (n !== null && !h) return null;
  const m = _ + p.index;
  let c = m + p[0].length;
  return (
    s && D.test(v.slice(c - 1, c + 1)) && ((p[0] += ' '), (c += 1)),
    m < g.pos && c >= g.pos
      ? {
          range: {
            from: m,
          ...
          query: p[0].slice(e.length),
          text: p[0],
        }
      : null
  );
}
const oe = new G('suggestion');
...
function se({
  ...
  allowedPrefixes: n = [' '],
  startOfLine: r = !1,
  decorationTag: g = 'span',
  decorationClass: i = 'suggestion',
  command: D = () => null,
  items: u = () => [],
  render: j = () => ({}),
  allow: v = () => !0,
  findSuggestionMatch: _ = ae,
}: any) {
  let p: any;
  const t = j == null ? void 0 : j(),
    h = new P({
      key: a,
      view() {
        return {
          update: async (m: any, c: any) => {
            var f, b, k, I, y, C, w;
            const l = (f = this.key) === null || f === void 0 ? void 0 : f.getState(c),
              d = (b = this.key) === null || b === void 0 ? void 0 : b.getState(m.state),
              A = l.active && d.active && l.range.from !== d.range.from,
              T = !l.active && d.active,
              H = l.active && !d.active,
              $ = !T && !H && l.query !== d.query,
              E = T,
            ...
            if (!E && !z && !q) return;
            const F = q && !E ? l : d,
              R = m.dom.querySelector(`[data-decoration-id="${F.decorationId}"]`);
            (p = {
              editor: o,
              range: F.range,
              query: F.query,
              ...
              clientRect: R
                ? () => {
                    var B;
                    const { decorationId: K } =
                        (B = this.key) === null || B === void 0 ? void 0 : B.getState(o.state),
                      S = m.dom.querySelector(`[data-decoration-id="${K}"]`);
                    return (S == null ? void 0 : S.getBoundingClientRect()) || null;
                  }
                : null,
            }),
              E &&
                ((k = t == null ? void 0 : t.onBeforeStart) === null ||
                  k === void 0 ||
                  k.call(t, p)),
              z &&
                ((I = t == null ? void 0 : t.onBeforeUpdate) === null ||
                  I === void 0 ||
                  I.call(t, p)),
              (z || E) &&
                (p.items = await u({
              ...
              q && ((y = t == null ? void 0 : t.onExit) === null || y === void 0 || y.call(t, p)),
              z && ((C = t == null ? void 0 : t.onUpdate) === null || C === void 0 || C.call(t, p)),
              E && ((w = t == null ? void 0 : t.onStart) === null || w === void 0 || w.call(t, p));
          },
          destroy: () => {
            var m;
            p && ((m = t == null ? void 0 : t.onExit) === null || m === void 0 || m.call(t, p));
          },
        };
      },
      state: {
        ...
        apply(m: any, c: any, f: any, b: any) {
          const { isEditable: k } = o,
            { composing: I } = o.view,
            { selection: y } = m,
            { empty: C, from: w } = y,
            l = {
          ...
          if (((l.composing = I), k && (C || o.view.composing))) {
            (w < c.range.from || w > c.range.to) && !I && !c.composing && (l.active = !1);
            const d = _({
                char: e,
                allowSpaces: s,
                allowedPrefixes: n,
            ...
            v({
              ...
              ? ((l.active = !0),
                (l.decorationId = c.decorationId ? c.decorationId : A),
                (l.range = d.range),
                (l.query = d.query),
                (l.text = d.text))
              : (l.active = !1);
      ...
      props: {
        handleKeyDown(m: any, c: any) {
          var f;
          const { active: b, range: k } = h.getState(m.state);
          return (
            (b &&
              ((f = t == null ? void 0 : t.onKeyDown) === null || f === void 0
                ? void 0
                : f.call(t, {
                    //@ts-ignore
                    view: m,
        ...
        decorations(m: any) {
          const { active: c, range: f, decorationId: b } = h.getState(m);
          return c
            ? O.create(m.doc, [
                //@ts-ignore
                U.inline(f.from, f.to, {
                  nodeName: g,
                  class: i,
...
var pe = (function () {
  ...
  var o = 25,
    ...
    s = Math.floor(o / 2);
  return (
    (a.font = s + 'px Arial, Sans-Serif'),
    (a.textBaseline = 'top'),
    (a.canvas.width = e * 2),
    (a.canvas.height = o),
    function (n: any) {
      a.clearRect(0, 0, e * 2, o),
        (a.fillStyle = '#FF0000'),
        a.fillText(n, 0, 22),
        (a.fillStyle = '#0000FF'),
        a.fillText(n, e, 22);
      for (
        var r = a.getImageData(0, 0, e, o).data, g = r.length, i = 0;
        i < g && !r[i + 3];
        i += 4
      );
      if (i >= g) return !1;
      var D = e + ((i / 4) % e),
        u = Math.floor(i / 4 / e),
        j = a.getImageData(D, u, 1, 1).data;
      return !(r[i] !== j[0] || r[i + 2] !== j[2] || a.measureText(n).width >= e);
    }
  );
})();
...
function le(a: any, o: any) {
  var e;
  return (e = o.find((s: any) => s.emoji === me(a))) == null ? void 0 : e.shortcodes[0];
}

function re(a: any, o = JSON.stringify) {
  const e: any = {};
  return a.filter((s: any) => {
    const n = o(s);
    return Object.prototype.hasOwnProperty.call(e, n) ? !1 : (e[n] = !0);
  });
}

function x(a: any, o: any) {
  return o.find((e: any) => a === e.name || e.shortcodes.includes(a));
}

const ge = /:([a-zA-Z0-9_+-]+):$/;

const de = /:([a-zA-Z0-9_+-]+):/g;
...
const je = V.create({
  ...
  addStorage() {
    const { emojis: a } = this.options as any,
      o = re(a.map((e: any) => e.version))
        .filter((e: any) => typeof e == 'number')
        .reduce((e: any, s: any) => {
          const n = a.find((r: any) => r.version === s && r.emoji);
          return {
            ...e,
            [s]: n ? te(n.emoji) : !1,
          };
    ...
    return {
      ...
      isSupported: (e: any) => (e.version ? o[e.version] : !1),
    };
  },
  addAttributes() {
    return {
      name: {
        default: null,
        parseHTML: (a: any) => a.dataset.name,
        renderHTML: (a: any) => ({
          'data-name': a.name,
        }),
      },
  ...
  renderHTML({ HTMLAttributes: a, node: o }: any) {
    const e = x(o.attrs.name, this.options.emojis),
      s = W(a, this.options.HTMLAttributes, {
        'data-type': this.name,
      });
    if (!e) return ['span', s, `:${o.attrs.name}:`];
    const n = this.storage.isSupported(e),
      r = !!(e != null && e.emoji),
      g = !!(e != null && e.fallbackImage),
      i =
        (this.options.forceFallbackImages && !r) ||
        (this.options.forceFallbackImages && g) ||
        (this.options.forceFallbackImages && !n && g) ||
        ((!n || !r) && g);
    return [
      'span',
      s,
      i
        ...
        : e.emoji || `:${e.shortcodes[0]}:`,
    ];
  },
  renderText({ node: a }: any) {
    const o = x(a.attrs.name, this.options.emojis);
    return (o == null ? void 0 : o.emoji) || `:${a.attrs.name}:`;
  },
  addCommands() {
    return {
      setEmoji:
        (a: any) =>
        ({ commands: o }: any) => {
          const e = x(a, this.options.emojis);
          return e
            ? o.insertContent({
                type: this.name,
                attrs: {
  ...
  addInputRules() {
    ...
    if (
      (a.push(
        new Z({
          find: ge,
          handler: ({ range: o, match: e, commands: s }: any) => {
            const n = e[1];
            x(n, this.options.emojis) &&
              s.insertContentAt(o, {
                type: this.name,
                attrs: {
                  name: n,
      ...
      const o = this.options.emojis
          .map((s) => s.emoticons)
          .flat()
          .filter((s) => s),
        e = new RegExp(`(?:^|\\s)(${o.map((s) => N(s)).join('|')}) $`);
      a.push(
        Y({
          find: e,
          type: this.type,
          getAttributes: (s) => {
            const n = this.options.emojis.find((r) => {
              var g;
              return (g = r.emoticons) == null ? void 0 : g.includes(s[1]);
            });
            if (n)
              return {
                name: n.name,
  ...
  addPasteRules() {
    return [
      new J({
        find: de,
        handler: ({ range: a, match: o, commands: e }: any) => {
          const s = o[1];
          x(s, this.options.emojis) &&
            e.insertContentAt(
              a,
              {
                type: this.name,
  ...
  addProseMirrorPlugins() {
    return [
      ...
      new P({
        key: new G('emoji'),
        props: {
          handleDoubleClickOn: (a: any, o: any, e: any) => {
        ...
        appendTransaction: (a: any, o: any, e: any) => {
          if (!(a.some((i: any) => i.docChanged) && !o.doc.eq(e.doc))) return;
          const { tr: n } = e,
            r = X(o.doc, a);
          if (
            (Q(r).forEach(({ newRange: i }: any) => {
              if (e.doc.resolve(i.from).parent.type.spec.code) return;
              ee(e.doc, i, (u: any) => u.type.isText).forEach(({ node: u, pos: j }) => {
                if (!u.text) return;
                [...u.text.matchAll(ne())].forEach((_) => {
                  if (_.index === void 0) return;
                  const p = _[0],
                    t = le(p, this.options.emojis);
                  if (!t) return;
                  const h = n.mapping.map(j + _.index);
                  if (e.doc.resolve(h).parent.type.spec.code) return;
                  const m = h + p.length,
                    c = this.type.create({
                      name: t,
                    });
                  n.replaceRangeWith(h, m, c);
                });
              });
            }),
            !!n.steps.length)
...
export { je as TiptapProExtensionEmoji };
